...
export default {
    ...
    'gui.classroom.teacherDashboard.create': 'クラスを作る',
    'gui.classroom.teacherCreate.title': 'クラスを作る',
    ...
    'gui.classroom.groups.manageButton': '組の管理',
    'gui.classroom.groups.create': '組をつくる',
    'gui.classroom.groups.namePlaceholder': '組の名前（例: 2年1組）',
    'gui.classroom.groups.yearLabel': '{year}年度',
    'gui.classroom.groups.sidebarHeader': '{name}（{year}年度）',
    'gui.classroom.groups.sidebarEmpty': 'まだ授業がありません',
    'gui.classroom.groups.archive': 'アーカイブ',
    'gui.classroom.groups.unarchive': 'もどす',
    'gui.classroom.groups.archivedBadge': 'アーカイブ済み',
    'gui.classroom.groups.empty': 'まだ組がありません',
    'gui.classroom.groups.back': 'もどる',
    'gui.classroom.groups.selectorLabel': '組',
