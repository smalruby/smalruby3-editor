...
export default {
    ...
    'gui.classroom.classList.namePlaceholder': 'クラス名（例: 2年1組）',
    'gui.classroom.classList.countPlaceholder': '人数',
    'gui.classroom.classList.assignmentPlaceholder': '最初の課題名（例: ねこを動かそう）',
