export default {
    ...
    'gui.smalruby3.rubyToBlocksConverter.couldNotConvertPrimitive': '「{ SOURCE }」はブロックに変換できません。つづりを確認するか、対応している値を使ってください。',
    'gui.smalruby3.rubyToBlocksConverter.wrongInstruction': '「{ SOURCE }」は命令がまちがっています。つづりを確認するか、対応しているブロックを使ってください。',
    ...
    'gui.smalruby3.rubyToBlocksConverter.cannotChangeVariableScope': '「{VARIABLE}」、変数のスコープは変更できません。変数をいったん削除してから、正しいスコープで作り直してください。',
    'gui.smalruby3.rubyToBlocksConverter.alreadyDefinedMyBlock': '「{NAME}」というブロック定義はすでに存在しています。別の名前を使ってください。',
    'gui.smalruby3.rubyToBlocksConverter.costumeDoesNotExist': 'コスチューム「{NAME}」は存在しません。名前を確認するか、先にコスチュームを追加してください。',
    'gui.smalruby3.rubyToBlocksConverter.backdropDoesNotExist': '背景「{NAME}」は存在しません。名前を確認するか、先に背景を追加してください。',
    'gui.smalruby3.rubyToBlocksConverter.soundDoesNotExist': '音「{NAME}」は存在しません。名前を確認するか、先に音を追加してください。',
    'gui.smalruby3.rubyToBlocksConverter.stageNoMotionBlocks': 'ステージが選択されています：動きブロックは使えません。スプライトを選択してから使ってください。',
    'gui.smalruby3.rubyToBlocksConverter.conditionIsNotBoolean': '条件がブーリアンではありません：{SOURCE}。比較演算子（==、<、>など）を使ってください。',
    'gui.smalruby3.rubyToBlocksConverter.includeNotStatementBlocks': '命令ブロックではないブロックが含まれています。ブロック定義の中では命令ブロック（コマンド）だけを使ってください。',
    'gui.smalruby3.rubyToBlocksConverter.invalidMyBlockArgumentType': 'ブロック定義「{NAME}」の引数#{INDEX}の型がまちがっています。数値、文字列、またはブーリアンの値を使ってください。',
    'gui.smalruby3.rubyToBlocksConverter.wrongInstructionInMyBlock': '「{SOURCE}」は命令がまちがっています。つづりを確認するか、対応しているブロックを使ってください。',
