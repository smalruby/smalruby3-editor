...
export default {
    ...
    'gui.classroom.teacherDetail.archiveClassroom': '課題をアーカイブ',
    'gui.classroom.teacherDetail.archiveConfirm':
        'この課題をアーカイブしますか？課題ボードから見えなくなりますが、「アーカイブ済みの課題」からいつでも元に戻せます。',
    ...
    'gui.classroom.classList.showArchived': 'アーカイブ済みのクラス（{count}）',
    'gui.classroom.classList.restore': '元に戻す',
    ...
    'gui.classroom.shared.limitedBadge': '限定公開',
    'gui.classroom.shared.recommendedBadge': '推薦',
    'gui.classroom.shared.recommendedNote':
        'この課題は運営の推薦を受けています。みんなの課題への全体公開を検討してみませんか？',
    ...
    'gui.classroom.teacherDetail.shareSuggestion':
        'この課題、みんなの課題に共有しませんか？ 内容の充実した課題として運営のおすすめに選ばれました。',
    'gui.classroom.teacherDetail.shareSuggestionOpen': '共有フォームを開く',
    'gui.classroom.board.shareSuggested': '共有おすすめ',
    ...
    'gui.classroom.management.googleSignInHint':
        '自動でログインできませんでした。こちらのボタンからログインしてください。',
