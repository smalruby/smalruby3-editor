export default {
    ...
    'gui.howtos.mesh-tutorial-2.step2.title': 'スプライトを追加しよう',
    'gui.howtos.mesh-tutorial-2.step3.title': 'スプライトごとに別のプログラムがある',
    'gui.howtos.mesh-tutorial-2.step4.title': 'スプライトA（送る側）のプログラムを書こう',
    'gui.howtos.mesh-tutorial-2.step5.title': 'スプライトB（受け取る側）のプログラムを書こう',
    'gui.howtos.mesh-tutorial-2.step6.title': '実行して確認しよう',
    'gui.howtos.mesh-tutorial-2.step7.title': '次はネットワークでつなごう',
    // Mesh Tutorial 3
    'gui.howtos.mesh-tutorial-3.name': '2台のパソコンでつながろう',
    'gui.howtos.mesh-tutorial-3.step1.title': 'ネットワークで別々のパソコンとつながろう',
    'gui.howtos.mesh-tutorial-3.step2.title': 'Mesh拡張機能を追加しよう',
    'gui.howtos.mesh-tutorial-3.step3.title': 'PC1はホストになろう',
    'gui.howtos.mesh-tutorial-3.step4.title': 'PC2はメッシュに参加しよう',
    'gui.howtos.mesh-tutorial-3.step5.title': '変数とメッセージがネットワークで共有される',
    'gui.howtos.mesh-tutorial-3.step6.title': 'PC1（送る側）のプログラムを確認しよう',
    'gui.howtos.mesh-tutorial-3.step7.title': 'PC2（受け取る側）のプログラムを書こう',
    'gui.howtos.mesh-tutorial-3.step8.title': '2台で実行してみよう',
    'gui.howtos.mesh-tutorial-3.step9.title': 'まとめ＆次のステップ',
    // Mesh tag
    ...
    'gui.cards.insert-code': 'プログラムを入力する',
