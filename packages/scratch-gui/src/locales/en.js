...
export default {
    ...
    'gui.classroom.evaluation.strictnessLenient': 'Lenient',
    'gui.classroom.evaluation.strictnessStandard': 'Standard',
    'gui.classroom.evaluation.strictnessStrict': 'Strict',
    'gui.classroom.evaluation.seat': 'Seat',
    'gui.classroom.evaluation.overall': 'Overall',
    'gui.classroom.evaluation.back': 'Back',
    'gui.classroom.evaluation.runGrade': 'Run AI Grading',
    'gui.classroom.evaluation.runComment': 'Draft Student Comments',
    'gui.classroom.evaluation.exportCsv': 'Evaluation CSV',
    'gui.classroom.evaluation.exportAuditCsv': 'Audit CSV',
    ...
    'gui.classroom.breadcrumbs.evaluation': 'Evaluation',
    'gui.classroom.breadcrumbs.importGc': 'Import from Google Classroom',
    'gui.classroom.board.createCancel': 'Cancel',
    'gui.classroom.board.reuseCancel': 'Cancel',
    'gui.classroom.management.importedBadge': 'Imported',
    ...
    'gui.classroom.board.createNamePlaceholder': 'Assignment name (e.g. Move the cat)',
    'gui.classroom.board.createSubmit': 'Create',
    'gui.classroom.board.reuse': 'Reuse an assignment',
    'gui.classroom.board.reuseHint': 'Copy an existing assignment into this class:',
    'gui.classroom.board.reuseFilterAll': 'All classes',
    'gui.classroom.board.reuseCopy': 'Copy into this class',
    ...
    'gui.classroom.board.addTopic': 'Add',
    ...
    'gui.classroom.classSettings.sectionPlaceholder': 'Section (optional, e.g. Year 2 Class 1)',
    'gui.classroom.classSettings.countPlaceholder': 'Students',
    'gui.classroom.classSettings.coTeachersLabel': 'Co-teachers (class-wide)',
    'gui.classroom.classSettings.coTeacherPlaceholder': 'Co-teacher email',
    'gui.classroom.classSettings.addCoTeacher': 'Add',
    'gui.classroom.classSettings.archive': 'Archive',
    'gui.classroom.classSettings.unarchive': 'Unarchive',
    'gui.classroom.classSettings.cancel': 'Cancel',
    'gui.classroom.classSettings.save': 'Save',
    'gui.classroom.management.titleBarLogout': 'Logout',
    ...
    'gui.classroom.classList.create': 'Create a class',
    'gui.classroom.classList.createSubmit': 'Create class and assignment',
    'gui.classroom.classList.namePlaceholder': 'Class name (required, e.g. Technology)',
    'gui.classroom.classList.countPlaceholder': 'Number of students (required)',
    'gui.classroom.classList.assignmentPlaceholder':
        'First assignment name (optional \u2014 leave empty to create just the class)',
    'gui.classroom.classList.yearLabel': '{year} school year',
    'gui.classroom.classList.assignmentCount': '{count} assignments',
    'gui.classroom.classList.gcBadge': 'Google Classroom',
    'gui.classroom.classList.coTeacherBadge': 'Co-managed',
    'gui.classroom.classList.archivedBadge': 'Archived',
    'gui.classroom.classList.evaluate': 'Evaluate',
    'gui.classroom.classList.empty': 'No classes yet. Press "Create a class" to get started.',
    'gui.classroom.classList.back': '\u2039 Class list',
    'gui.classroom.groups.title': 'Class settings',
    ...
    'gui.classroom.groups.manageButton': 'Manage Groups',
    'gui.classroom.groups.create': 'Create Group',
    'gui.classroom.groups.namePlaceholder': 'Group name (e.g. Year 2 Class 1)',
    'gui.classroom.groups.yearLabel': '{year} school year',
    'gui.classroom.groups.sidebarHeader': '{name} ({year})',
    'gui.classroom.groups.sidebarEmpty': 'No lessons yet',
    'gui.classroom.groups.archive': 'Archive',
    'gui.classroom.groups.unarchive': 'Restore',
    'gui.classroom.groups.archivedBadge': 'Archived',
    'gui.classroom.groups.empty': 'No groups yet',
    'gui.classroom.groups.back': 'Back',
    'gui.classroom.groups.selectorLabel': 'Group',
    'gui.classroom.groups.selectorNone': '(none)',
    'gui.classroom.groups.duplicate': 'Duplicate',
    'gui.classroom.groups.duplicateSuffix': ' (copy)',
    ...
    'gui.classroom.assignmentEditor.hint':
        'Students see these pages and the starter project opens automatically when they join with the class code.',
    'gui.classroom.assignmentEditor.pageNumber': 'Page {number}',
    'gui.classroom.assignmentEditor.pageTextPlaceholder': 'Write instructions for this page (a few lines)',
    'gui.classroom.assignmentEditor.moveUp': 'Move up',
    'gui.classroom.assignmentEditor.moveDown': 'Move down',
    'gui.classroom.assignmentEditor.removePage': 'Delete page',
    'gui.classroom.assignmentEditor.attachImage': 'Add Image (1 per page)',
    'gui.classroom.assignmentEditor.removeImage': 'Remove Image',
    'gui.classroom.assignmentEditor.addPage': '+ Add Page',
    'gui.classroom.assignmentEditor.starterTitle': 'Starter Project',
    'gui.classroom.assignmentEditor.starterNone': 'Starter project: none',
    'gui.classroom.assignmentEditor.starterKept': 'Starter project: set (kept as-is)',
    'gui.classroom.assignmentEditor.starterFromProject':
        'New starter: the currently open project (saved when you save the assignment)',
    'gui.classroom.assignmentEditor.starterFromFile': 'New starter: {name}',
    'gui.classroom.assignmentEditor.useCurrentProject': 'Use the Open Project',
    'gui.classroom.assignmentEditor.useFile': 'Choose .sb3 File',
    'gui.classroom.assignmentEditor.removeStarter': 'Remove Starter',
    'gui.classroom.assignmentEditor.starterRemoveWarning':
        'The existing starter project will be deleted when you save.',
    'gui.classroom.assignmentEditor.cancel': 'Cancel',
    'gui.classroom.assignmentEditor.save': 'Save Assignment',
    'gui.classroom.assignmentEditor.limitsNote':
        'Up to 10 pages, 500 characters and one image per page, one starter project.',
    'gui.classroom.assignmentEditor.errorTextTooLong': 'Page {page} text is too long (max 500 characters)',
    'gui.classroom.assignmentEditor.errorTooManyPages': 'An assignment may have at most 10 pages',
    'gui.classroom.assignmentEditor.errorBadImageType': 'Images must be PNG or JPEG',
    ...
    'gui.classroom.management.googleSignInHint': 'Could not sign in automatically. Please use the button below.',
    ...
    'gui.classroom.management.create': 'Create an assignment',
    'gui.classroom.management.googleImport': 'GC Import',
    'gui.classroom.management.logout': 'Logout',
    'gui.classroom.management.googleCoursesTitle': 'Import from Google Classroom',
    ...
    'gui.menuBar.koshienSettings': 'Practice settings',
    'gui.menuBar.koshienMockPanel': 'Practice game panel',
    'gui.koshienSettingsModal.title': 'Koshien practice settings',
    'gui.koshienSettingsModal.map': 'Practice map',
    'gui.koshienSettingsModal.side': 'Your player',
    'gui.koshienSettingsModal.rival': 'Rival AI',
    'gui.koshienSettingsModal.rivalGoal': 'Heads for the goal',
    ...
    'gui.koshienMockPanel.shrink': 'Shrink',
    'gui.koshienMockPanel.expand': 'Expand',
    'gui.koshienMockPanel.close': 'Close',
    'gui.koshienMockPanel.notConnected': 'Run "connect to game server" to start a practice game.',
    'gui.koshienMockPanel.viewAll': 'All',
    'gui.koshienMockPanel.viewMine': 'My AI',
    'gui.koshienMockPanel.turn': 'Turn',
    'gui.koshienMockPanel.gameOver': 'Game over',
    'gui.koshienMockPanel.you': 'You',
    'gui.koshienMockPanel.rival': 'Rival',
    'gui.koshienMockPanel.score': 'Score',
    'gui.koshienMockPanel.actionsLeft': 'Actions left',
    'gui.koshienMockPanel.canMove': 'Move left',
    'gui.koshienMockPanel.dynamite': 'Dynamite',
    'gui.koshienMockPanel.bomb': 'Bombs',
    'gui.koshienMockPanel.inWater': 'In water!',
    'gui.koshienMockPanel.journal': 'Log',
    'gui.koshienMockPanel.expandLog': '🔲 Expand',
    'gui.koshienMockPanel.shrinkLog': '🔳 Normal',
    ...
    'gui.koshienMockPanel.tipNone': 'none',
    'gui.koshienMockPanel.tipRivalHere': 'Rival',
    'gui.koshienMockPanel.tipFiendHere': 'Fiend',
    'gui.koshienMockPanel.terrainSpace': 'space',
    'gui.koshienMockPanel.terrainWall': 'wall',
    'gui.koshienMockPanel.terrainStorehouse': 'storehouse',
    'gui.koshienMockPanel.terrainGoal': 'goal',
    'gui.koshienMockPanel.terrainWater': 'water',
    'gui.koshienMockPanel.terrainBreakable': 'breakable wall',
    'gui.koshienMockPanel.terrainUnknown': 'unexplored',
    'gui.koshienMockPanel.itemTea': 'tea',
    'gui.koshienMockPanel.itemSweets': 'sweets',
    'gui.koshienMockPanel.itemCoin': 'coin',
    'gui.koshienMockPanel.itemDolphin': 'dolphin',
    'gui.koshienMockPanel.itemSword': 'sword',
    'gui.koshienMockPanel.itemPoison': 'poison',
    'gui.koshienMockPanel.itemSnake': 'snake',
    'gui.koshienMockPanel.itemTrap': 'trap',
    'gui.koshienMockPanel.itemBomb': 'bomb',
