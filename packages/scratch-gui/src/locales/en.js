export default {
    ...
    'gui.smalruby3.rubyToBlocksConverter.invalidBackdropName': 'backdrop "{ NAME }" does not exist in the backdrop library.',
    'gui.smalruby3.rubyToBlocksConverter.spriteMethodInStageClass': '"{ METHOD }" cannot be used in class Stage. This method is only available for sprites.',
    'gui.smalruby3.rubyToBlocksConverter.stageMethodInSpriteClass': '"{ METHOD }" cannot be used in a sprite class. This method is only available for class Stage.',
    'gui.smalruby3.rubyToBlocksConverter.classNotSupportedInV1': 'class definitions are not supported in Ruby version 1. Please switch to Ruby version 2 from the settings menu.',
    ...
    'gui.howtos.chat-2-sprites-2.step2.title': 'Cat: Create variable "sent message", place "when this sprite clicked" and "set sent message to ___"',
    'gui.howtos.chat-2-sprites-2.step3.title': 'Cat: Add "say ___ for ___ secs" and ★ "broadcast ___" — it runs blocks far away!',
    'gui.howtos.chat-2-sprites-2.step4.title': '★ Cat: Place "when I receive Penguin\'s message" and use variable "received message" (this sprite only) — @ variables are sprite-local!',
    ...
    'gui.howtos.chat-2-sprites-2.step7.title': '★ Build the same block structure for Penguin — message names are reversed!',
    ...
    'gui.howtos.chat-2-sprites-3.step4.title': '★ Change say("change this", 3) to say(@received_message, 3) — @ variables belong to this sprite only!',
