export default {
    ...
    'gui.smalruby3.rubyToBlocksConverter.couldNotConvertPrimitive': '「{ SOURCE }」はブロックにへんかんできません。つづりをかくにんするか、たいおうしているあたいをつかってください。',
    'gui.smalruby3.rubyToBlocksConverter.wrongInstruction': '「{ SOURCE }」はめいれいがまちがっています。つづりをかくにんするか、たいおうしているブロックをつかってください。',
    ...
    'gui.smalruby3.rubyToBlocksConverter.cannotChangeVariableScope': '「{VARIABLE}」、へんすうのスコープはへんこうできません。へんすうをいったんさくじょしてから、ただしいスコープでつくりなおしてください。',
    'gui.smalruby3.rubyToBlocksConverter.alreadyDefinedMyBlock': '「{NAME}」というブロックていぎはすでにそんざいしています。べつのなまえをつかってください。',
    'gui.smalruby3.rubyToBlocksConverter.costumeDoesNotExist': 'コスチューム「{NAME}」はそんざいしません。なまえをかくにんするか、さきにコスチュームをついかしてください。',
    'gui.smalruby3.rubyToBlocksConverter.backdropDoesNotExist': 'はいけい「{NAME}」はそんざいしません。なまえをかくにんするか、さきにはいけいをついかしてください。',
    'gui.smalruby3.rubyToBlocksConverter.soundDoesNotExist': 'おと「{NAME}」はそんざいしません。なまえをかくにんするか、さきにおとをついかしてください。',
    'gui.smalruby3.rubyToBlocksConverter.stageNoMotionBlocks': 'ステージがせんたくされています：うごきブロックはつかえません。スプライトをせんたくしてからつかってください。',
    'gui.smalruby3.rubyToBlocksConverter.conditionIsNotBoolean': 'じょうけんがブーリアンではありません：{SOURCE}。ひかくえんざんし（==、<、>など）をつかってください。',
    'gui.smalruby3.rubyToBlocksConverter.includeNotStatementBlocks': 'めいれいブロックではないブロックがふくまれています。ブロックていぎのなかではめいれいブロック（コマンド）だけをつかってください。',
    'gui.smalruby3.rubyToBlocksConverter.invalidMyBlockArgumentType': 'ブロックていぎ「{NAME}」のひきすう#{INDEX}のかたがまちがっています。すうち、もじれつ、またはブーリアンのあたいをつかってください。',
    'gui.smalruby3.rubyToBlocksConverter.wrongInstructionInMyBlock': '「{SOURCE}」はめいれいがまちがっています。つづりをかくにんするか、たいおうしているブロックをつかってください。',
