...
export default {
    ...
    'gui.classroom.classList.namePlaceholder': 'クラスめい（れい: 2ねん1くみ）',
    'gui.classroom.classList.countPlaceholder': 'にんずう',
    'gui.classroom.classList.assignmentPlaceholder': 'さいしょのかだいめい（れい: ねこをうごかそう）',
