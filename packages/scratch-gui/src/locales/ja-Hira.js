...
export default {
    ...
    'gui.classroom.groups.manageButton': 'くみのかんり',
    'gui.classroom.groups.create': 'くみをつくる',
    'gui.classroom.groups.namePlaceholder': 'くみのなまえ（れい: 2ねん1くみ）',
    'gui.classroom.groups.yearLabel': '{year}ねんど',
    'gui.classroom.groups.sidebarHeader': '{name}（{year}ねんど）',
    'gui.classroom.groups.sidebarEmpty': 'まだじゅぎょうがありません',
    'gui.classroom.groups.archive': 'アーカイブ',
    'gui.classroom.groups.unarchive': 'もどす',
    'gui.classroom.groups.archivedBadge': 'アーカイブずみ',
    'gui.classroom.groups.empty': 'まだくみがありません',
    'gui.classroom.groups.back': 'もどる',
    'gui.classroom.groups.selectorLabel': 'くみ',
