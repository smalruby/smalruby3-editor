...
const savedShowAllExtensions =
    typeof window !== 'undefined' && window.localStorage
        ? window.localStorage.getItem(SHOW_ALL_EXTENSIONS_KEY) === 'true'
        : false;
...
export { reducer as default, initialState as extensionFilterInitialState, toggleShowAllExtensions };
