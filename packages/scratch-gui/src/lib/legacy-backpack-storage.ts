...
// === Smalruby: Start of localStorage backpack support ===
import {
...
// === Smalruby: End of localStorage backpack support ===
...
export class LegacyBackpackStorage implements GUIBackpackStorage {
    ...
    private getBackpackAssetURL (asset: Asset): string {
        // === Smalruby: Start of localStorage backpack support ===
        if (this.host === 'localStorage') {
            return getLocalStorageBackpackAssetURL(this.host, asset.assetId);
        }
        // === Smalruby: End of localStorage backpack support ===
