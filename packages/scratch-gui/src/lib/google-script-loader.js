 ...
 */
export const loadGoogleAPI = () => loadScript('https://apis.google.com/js/api.js', 'google-api-script')
 ...
 */
export const loadGoogleIdentity = () => loadScript('https://accounts.google.com/gsi/client', 'google-identity-script')
 ...
 */
export const areAllGoogleScriptsLoaded = () => isGoogleAPILoaded() && isGoogleIdentityLoaded()
