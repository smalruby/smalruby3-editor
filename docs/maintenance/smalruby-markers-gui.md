...
| `src/components/menu-bar/settings-menu.jsx` | display mode menu | 表示モード (自動/PC/スマホ) 切替メニュー。`useDisplayMode` hook + `persistDisplayMode` の import、ハンドラ、レンダリング (Issue #865) |
