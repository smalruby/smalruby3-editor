...
| `src/components/cards/cards.jsx` | internal resource action | externalResources の `action: 'openTipsLibrary'` でチュートリアル一覧を再表示する内部アクションを受け付ける拡張 (PreviewExternalStep) |
